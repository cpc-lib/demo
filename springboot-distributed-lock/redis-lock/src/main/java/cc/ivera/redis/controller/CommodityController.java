package cc.ivera.redis.controller;

import cc.ivera.common.result.Result;
import cc.ivera.redis.service.CommodityStockService;
import cc.ivera.redis.utils.RedisDistributeLock;
...
public class CommodityController {
    ...
    // 使用redisson分布式锁(正常流程走，这个是有问题的 导致connection出问题)
    ...
    // 使用redisson分布式锁(@Transactional的Spring事务的提交)
