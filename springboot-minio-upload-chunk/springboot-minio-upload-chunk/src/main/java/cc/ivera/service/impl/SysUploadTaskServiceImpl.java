...
import cc.ivera.constant.MinioConstant;
import org.springframework.http.MediaType;
import org.springframework.http.MediaTypeFactory;
import cc.ivera.model.dto.TaskInfoDTO;
import cc.ivera.model.dto.TaskRecordDTO;
import cc.ivera.model.entity.SysUploadTask;
import cc.ivera.mapper.SysUploadTaskMapper;
import cc.ivera.model.param.InitTaskParam;
import cc.ivera.properties.MinioProperties;
import cc.ivera.service.SysUploadTaskService;
...
public class SysUploadTaskServiceImpl extends ServiceImpl<SysUploadTaskMapper, SysUploadTask> implements SysUploadTaskService {
    ...
    public TaskInfoDTO initTask(InitTaskParam param) {
        ...
        String key = StrUtil.format("{}/{}.{}", DateUtil.format(currentDate, "yyyyMMdd"), IdUtil.randomUUID(), suffix);
