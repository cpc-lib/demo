...
import cc.ivera.entity.Evection;
import cc.ivera.entity.FlowInfo;
import cc.ivera.entity.User;
import cc.ivera.utils.SpringContextUtil;
...
public class ActFlowCommService {
    ...
    public void saveNewDeploy(FlowInfo flowInfo) {
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource(flowInfo.getFile_path()) // 添加bpmn资源
                .name(flowInfo.getFlow_key())
                .deploy();
//        4、输出部署信息
            ...
            if (processInstance != null) {
                ...
                if (!StringUtils.isBlank(businessKey)) {
                    ...
                    if (type.equals("evection")) {
                        ...
                        User userInfo = userService.findOneUserById(evection.getUser_id());
