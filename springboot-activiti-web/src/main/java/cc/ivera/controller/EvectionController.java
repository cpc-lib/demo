...
import cc.ivera.service.ActFlowCommService;
import cc.ivera.service.EvectionService;
...
public class EvectionController {
    ...
    public List<Evection> findAll(HttpServletRequest request) {
        ...
        List<Evection> list = evectionService.findList(userId);
        return list;
    }
