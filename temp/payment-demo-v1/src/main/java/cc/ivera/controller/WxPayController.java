...
//            TimeUnit.SECONDS.sleep(5);
    ...
    @ApiOperation("申请退款")
    @PostMapping("/refunds")
    public R refunds(@RequestBody RefundRequest request) throws Exception {
        log.info("申请退款");
    ...
    public R refundsLegacy(@PathVariable String orderNo, @PathVariable String reason) throws Exception {
        log.info("申请退款(旧接口)");
