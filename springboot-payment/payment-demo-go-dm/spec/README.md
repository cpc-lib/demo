...
- [达梦数据库迁移](implemented/database/DAMENG_DATABASE_MIGRATION_SPEC.md)
- [退款审核后自动查询](implemented/refund/REFUND_AUTO_QUERY_AFTER_APPROVAL_SPEC.md)
...
- [支付应用单选入口](implemented/payment-config/PAYMENT_APP_ONLY_FRONTEND_SELECTION_SPEC.md)
...
- 新增或改动 HTTP API、状态值、DB schema、MQ 名称、配置字段、第三方回调响应、前端调用契约时，先新增或更新 spec。
