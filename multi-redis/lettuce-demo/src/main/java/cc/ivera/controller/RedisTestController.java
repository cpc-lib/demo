...
import cc.ivera.util.RedisHashUtil;
import cc.ivera.util.RedisListUtil;
import cc.ivera.util.RedisSetUtil;
import cc.ivera.util.RedisValUtil;
...
public class RedisTestController {
    ...
    public String test(@PathVariable("key") String key) {
        redisValUtil.set(key, "默认库设置");//默认库0
