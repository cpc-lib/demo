package cc.ivera.DMA8_代理模式;

import cc.ivera.DMA8_代理模式.DM8.NP非代理.UserOwn;
import cc.ivera.DMA8_代理模式.DM8.ProxyFactory;
import cc.ivera.DMA8_代理模式.DM8.VP虚拟代理.Secretary;
import cc.ivera.DMA8_代理模式.DM8.service.CommodityService;
import cc.ivera.DMA8_代理模式.DM8.service.impl.DogImpl;
import cc.ivera.DMA8_代理模式.DM8.service.impl.UserImpl;
...
public class ProxyTest {
    ...
    private static void useStaticProxy(String uName, String dName) {
        ...
        CommodityService userProxy = ProxyFactory.getUserProxy();
    ...
    private static void useDynamicProxy(String uName, String dName) {
        ...
        userProxy.getCommodity(uName);//先调用DynamicProxy的invoke方法
        System.out.println("===========分割线");
