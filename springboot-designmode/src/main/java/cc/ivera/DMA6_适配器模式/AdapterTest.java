package cc.ivera.DMA6_适配器模式;

import cc.ivera.DMA6_适配器模式.DM6.CAdapter类.QQPlayer;
import cc.ivera.DMA6_适配器模式.DM6.IAdapter接口.APlayer;
import cc.ivera.DMA6_适配器模式.DM6.IAdapter接口.AbstractPlayer;
import cc.ivera.DMA6_适配器模式.DM6.IAdapter接口.BPlayer;
import cc.ivera.DMA6_适配器模式.DM6.IAdapter接口.CPlayer;
import cc.ivera.DMA6_适配器模式.DM6.Mp3;
import cc.ivera.DMA6_适配器模式.DM6.OAdapter对象.BaoFengPlayer;
import cc.ivera.DMA6_适配器模式.DM6.Player;
