package cc.ivera.DMB19_备忘录模式;

import cc.ivera.DMB19_备忘录模式.DM19.事务回滚.OriginData;
import cc.ivera.DMB19_备忘录模式.DM19.事务回滚.TransitionStorage;
import cc.ivera.DMB19_备忘录模式.DM19.传统模式.Original;
import cc.ivera.DMB19_备忘录模式.DM19.传统模式.Storage;
