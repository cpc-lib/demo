package cc.ivera.grpcserver.demo.provider;


import cc.ivera.grpcprotocol.*;
import cc.ivera.grpcserver.demo.model.SubjectMarksModel;
...
@GrpcService
public class ServiceProvider extends RemoteServiceGrpc.RemoteServiceImplBase {
