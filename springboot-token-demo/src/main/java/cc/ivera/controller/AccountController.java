...
import cc.ivera.redis.RedisUtil;
import cc.ivera.service.AuthorizationService;
...
public class AccountController {
    ...
    public String login(@RequestParam(name = "account") String account,
        ...
        if(user != null && password != null && password.equals(user.getPassword())){
            ...
            cache.set("id_refreshTokenStartTime"+account,
                    System.currentTimeMillis(),(int)AuthorizationService.refreshTokenExpirationTime);
     ...
     */
    @GetMapping("/refresh")
    public String accessTokenRefresh(@RequestParam("refreshToken") String refreshToken){
    ...
    public String userInfo(@RequestParam("accessToken") String accessToken){
