...
>2.8+
>
>kafka-topics.bat --bootstrap-server localhost:9092 --create --topic s1pTopic --partitions 5 --replication-factor 1
>
>kafka-topics.bat --bootstrap-server localhost:9092 --create --topic s1pFooTopic --partitions 5 --replication-factor 1
