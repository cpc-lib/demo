...
import cc.ivera.model.pojo.itextpdf.MyHeaderFooterPageEventHelper;
import cc.ivera.model.pojo.itextpdf.User;
...
public class UserServiceImpl implements IUserService {
    ...
    public Document generateItextPdfDocument(OutputStream os) throws Exception {
        ...
        // 图片
        Resource resource = new ClassPathResource("itext-pdf/pdai-guli.png");
    ...
    private List<User> getUserList() {
        ...
        for (int i = 0; i < 5; i++) {
            userList.add(User.builder().id(Long.parseLong(i + "")).userName("pdai" + i).email("pdai@pdai.tech" + i).phoneNumber(121231231231L).description("hello world" + i).build());
        }
        return userList;
    }
