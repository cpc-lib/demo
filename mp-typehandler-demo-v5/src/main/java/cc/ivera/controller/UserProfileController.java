...
public class UserProfileController {
    ...
    @PostMapping("/add")
    public Map<String, Object> add(@RequestHeader(value = "X-Operator", required = false) String operator,
                                   HttpServletRequest httpServletRequest) {
        Long id = userProfileService.addDemoUser(operator, httpServletRequest.getRequestURI());
        Map<String, Object> result = new HashMap<>();
        result.put("success", true);
        result.put("id", id);
        result.put("logMode", "ANNOTATION");
        result.put("operationType", "CREATE");
        return result;
    }
    ...
    public Map<String, Object> addCustom(@RequestBody CreateUserRequest request,
                                         ...
                                         HttpServletRequest httpServletRequest) {
        Long id = userProfileService.addCustomUser(
                request.getName(),
                request.getHobbies(),
                request.getTags(),
                operator,
    ...
    public Map<String, Object> update(@PathVariable Long id,
        ...
        result.put("id", id);
        result.put("logMode", "ANNOTATION");
        result.put("operationType", "UPDATE");
        return result;
    }
    ...
    public Map<String, Object> delete(@PathVariable Long id,
                                      @RequestHeader(value = "X-Operator", required = false) String operator,
                                      HttpServletRequest httpServletRequest) {
        boolean success = userProfileService.deleteById(id, operator, httpServletRequest.getRequestURI());
        Map<String, Object> result = new HashMap<>();
        result.put("success", success);
        result.put("id", id);
        result.put("logMode", "ANNOTATION");
        result.put("operationType", "DELETE");
        return result;
    }
