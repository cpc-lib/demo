...
#单机密码
redis.conf 中配置 requirepass xxx
```
...
https://blog.51cto.com/u_16213320/9542881
...
#在主机配置
requirepass xxx 主机密码
#在从机配置
masterauth xxx 主机密码
#在sentinel中配置
sentinel auth-pass mymaster xxx 主机密码
```
...
redis-server /usr/local/redis-6.2.4/conf/7001/redis.conf
redis-server /usr/local/redis-6.2.4/conf/7002/redis.conf
redis-server /usr/local/redis-6.2.4/conf/7003/redis.conf
redis-server /usr/local/redis-6.2.4/conf/8001/redis.conf
redis-server /usr/local/redis-6.2.4/conf/8002/redis.conf
redis-server /usr/local/redis-6.2.4/conf/8003/redis.conf
```
...
redis-cli --cluster create --cluster-replicas 1 101.32.189.58:7001 101.32.189.58:7002 101.32.189.58:7003 101.32.189.58:8001 101.32.189.58:8002 101.32.189.58:8003
```
...
#数据slot错误的解决办法
https://blog.csdn.net/gao_grace/article/details/95085609
```
